...
class Dnd(commands.Cog, name='!DnDCommands'):
    ...
    @commands.command(name='origin', brief='Where it all began', help='![] Bot idea origin')
    @commands.guild_only()
    ...
    # todo
    @commands.command(name='intro', brief='And now...', help='![]Quest introduction')
    @commands.guild_only()
    ...
    @commands.command(name='embark', brief='Embark on the quest!', help='![character name] to embark on the quest!')
    @commands.guild_only()
    ...
    @commands.command(name='add_objective', hidden=True, brief='Add quest objective', help='![name] [description] Adds an objective to the quest')
    ...
    # todo
    @commands.command(name='objectives', brief='Show current objectives', help='![] The current objective')
    @commands.guild_only()
    ...
    @commands.command(name='solve', hidden=True, brief='Solve objective', help='![objective id] Solve an objective')
    @commands.has_role('Inconsistent')
    @commands.guild_only()
    ...
    @commands.command(name='add_location', hidden=True, brief='Add location', help='![place] Adds a new location')
    @commands.has_role('Inconsistent')
    @commands.guild_only()
    ...
    @commands.command(name='location', brief='Current party location', help='![] The current party location')
    @commands.guild_only()
    ...
    @commands.command(name='roll', brief='Roll the dice', help='![die] Written as number of dice, d, die count. Ex: 2d20 will roll 2 20-sided dice.')
    @commands.guild_only()
